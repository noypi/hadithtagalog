...
const bukhariSectionsOffset = require("./json/sections/bukhari-sections.json");
const bukhariSectionName_tagalog = require("./json/sections/bukhari-sections-name_tagalog.json");
const bukhariSectionName_english = require("./json/sections/bukhari-sections-name_english.json");
const bukhariSectionsOffsetSorted = Object.values(bukhariSectionsOffset).sort((a, b) => a[SECTION_FIRST] > b[SECTION_FIRST]);

const abudawudSectionName_english = require("./json/sections/abudawud-sections-name_english.json");
const abudawudSectionName_arabic = abudawudSectionName_english;
const ibnmajahSectionName_english = require("./json/sections/ibnmajah-sections-name_english.json");
const ibnmajahSectionName_arabic = ibnmajahSectionName_english;
const malikSectionName_english = require("./json/sections/malik-sections-name_english.json");
const malikSectionName_arabic = malikSectionName_english;
const muslimSectionName_english = require("./json/sections/muslim-sections-name_english.json");
const muslimSectionName_arabic = muslimSectionName_english;
const nasaiSectionName_english = require("./json/sections/nasai-sections-name_english.json");
const nasaiSectionName_arabic = nasaiSectionName_english;
const tirmidhiSectionName_english = require("./json/sections/tirmidhi-sections-name_english.json");
...
export function hadithSectionNameOf(book, sectionId, lang = $locale.locale) {
...
export const hadithSectionInfoOf = (hadithId, lang = $locale.locale) => {
    const [book, id] = split_hadith_id(hadithId);
